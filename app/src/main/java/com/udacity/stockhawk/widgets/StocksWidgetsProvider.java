...
public class StocksWidgetsProvider extends AppWidgetProvider {
    @Override
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            ...
            views.setRemoteAdapter(R.id.widget_list, new Intent(context, StocksWidgetsRemoteViewsService.class));
